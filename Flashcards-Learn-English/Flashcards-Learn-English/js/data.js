...
(function () {
    ...
    Logic.addCardToDeck(new Models.CardModel(
        ...
        "noun",
        "(hôrs)"), animals.decks[0]);
    Logic.addCardToDeck(new Models.CardModel(
        "гъсеница",
        "Caterpillar",
        "The wormlike larva of a butterfly or moth.",
        "noun",
        "(kătˈər-pĭlˌər, kătˈə-)"), animals.decks[0]);
    Logic.addCardToDeck(new Models.CardModel(
        "котка",
        "Cat",
    ...
    Logic.addCardToDeck(new Models.CardModel(
        ...
        "noun",
        "(kī-ōˈtē, kīˈōtˌ)"), animals.decks[0]);
    Logic.addCardToDeck(new Models.CardModel(
        "крокодил",
        "Crocodile",
    ...
    Logic.addCardToDeck(new Models.CardModel(
        ...
        "noun",
        "(hĭpˌə-pŏtˈə-məs)"), animals.decks[0]);
    Logic.addCardToDeck(new Models.CardModel(
        "медуза",
        "Jellyfish",
